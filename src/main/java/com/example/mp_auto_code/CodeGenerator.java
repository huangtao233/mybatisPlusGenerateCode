package com.example.mp_auto_code;
...
public class CodeGenerator {
    //作者
    private static final String author = "huangtao";

    //数据库
    private static final String url = "jdbc:mysql://localhost:3306/db_shoe?characterEncoding=utf-8&serverTimezone=GMT%2B8&zeroDateTimeBehavior=convertToNull";
